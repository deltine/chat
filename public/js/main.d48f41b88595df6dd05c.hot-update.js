...
eval("throw new Error(\"Module parse failed: Unexpected token (36:8)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|     var ShowMessegeList = function () {\\n|         return (React.createElement(\\\"div\\\", null, messageList.map(function (message, index) { return (React.createElement(\\\"div\\\", null,\\n>         ,\\n|             \\\"if (true) \\\", ({ index: index }, { message: message, : .name }, { message: message, : .message }),\\n|             \\\"}\\\",\");\n\n//# sourceURL=webpack:///./src/features/Chat/Chat.tsx?");
