...
eval("throw new Error(\"Module parse failed: Unexpected token (14:29)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|     var name = useSelector(selectName);\\n|     var _a = useState(\\\"\\\"), text = _a[0], setText = _a[1];\\n>     var _b = useState({ \\\"a\\\": , \\\"b\\\": , \\\"c\\\":  }), texts = _b[0], setTexts = _b[1];\\n|     // signIn()のレスポンスを設定\\n|     var signInMessage = useSelector(selectSignInMessage);\");\n\n//# sourceURL=webpack:///./src/features/Chat/Chat.tsx?");
